...
var config = {
    url: 'http://automoviles.autoscout24.es/'
};
...
function getData(html){
    ...
    $(".mt-Card .mt-Card-body").each(function(i, elem) {
        ...
        var veh = {
            ...
            price: $body.find('.mt-CardAd-price strong').text().replace('.','').replace('€',''),
            cv: '',
            description: ''
        };
...
module.exports = {
    search: function(responseCallback){
        ...
        startRequestMaData(config.url,
            '?atype=C&mmvmk0=74&mmvmd0=-106&cy=E&ustate=N%2CU&ipc=home%3Asearchbox&ipl=button&zipr=200&zipc=E&dtr=s',
            json,
            responseCallback);
    }
};
